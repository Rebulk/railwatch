...
module Railwatch
  ...
  # subscribers emit it, generated by spec/railwatch/wire_fixtures_spec.rb.
  # A receiver tests its mapper against these instead of hand-writing what
  # it thinks the gem sends.
  def self.wire_fixtures_path
    File.expand_path("../lib/railwatch/wire_fixtures.json", __dir__)
  end

  def self.wire_fixtures
    @wire_fixtures ||= JSON.parse(File.read(wire_fixtures_path)).freeze
  end
