...
require "nightrail/patches/net_http"
require "nightrail/patches/rake_task"
require "nightrail/patches/runner_command"
require "nightrail/patches/inertia"
...
module Nightrail
  module Patches
    ...
    def install_runner_command!
      ...
      Nightrail.debug { "runner command patch not installed: #{e.class}: #{e.message}" }
      nil
    end
  end
end
