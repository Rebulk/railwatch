...
module Nightrail
  ...
  # Nightrail records; Nightrail.context writes to all three.
  module Context
    LIMIT = 65_536
    EMPTY_JSON = "{}".freeze
    # Present, and true, on a context that did not fit in LIMIT bytes.
    TRUNCATION_KEY = "_nightrail_truncated"
    ...
    def serialize(context)
      filtered = Nightrail.redactor.params(context)
    ...
    # `_nightrail_truncated` says it happened. The result is always valid JSON.
