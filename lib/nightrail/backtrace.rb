...
module Nightrail
  ...
  module Backtrace
    ...
    # The gem's own lib/ directory, so frames inside Nightrail are skipped by
    # prefix rather than by a substring that would also match any app whose
    # checkout happens to live under a folder named "nightrail" (including
    ...
    # etc). Nightrail itself is excluded separately via gem_root because in
